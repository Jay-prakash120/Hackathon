      ...
      {result && (
        ...
        >
          ...
          <div style={{ marginTop: "16px", display: "flex", justifyContent: "flex-end" }}>
            <button
               onClick={() => { setReported(true); addToast("Report successfully submitted to the Verified Reporter Queue!"); }}
               disabled={reported}
               style={{
                  background: "var(--bg-secondary)",
                  border: "1px solid var(--border-subtle)",
                  color: reported ? "var(--text-muted)" : "var(--text-secondary)",
                  padding: "6px 14px",
                  borderRadius: "6px",
                  fontSize: "0.85rem",
               ...
               onMouseOver={(e) => { if(!reported) e.currentTarget.style.background = "rgba(255, 255, 255, 0.05)"; }}
               onMouseOut={(e) => { if(!reported) e.currentTarget.style.background = "var(--bg-secondary)"; }}
            >
               🚩 {reported ? "Reported to Experts" : "Flag AI Prediction"}
            </button>
          </div>

          <div className="section-divider" />

          {/* Expert Community Note Demonstration */}
          {text.toLowerCase().includes("space treaty") && (
            <div className="animate-fade-in-up" style={{
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "10px" }}>
                ...
                <span style={{ fontWeight: 800, color: "var(--accent-cyan)", fontSize: "0.95rem", textTransform: "uppercase", letterSpacing: "1px" }}>Community Note</span>
              </div>
              <p style={{ color: "var(--text-primary)", fontSize: "0.95rem", lineHeight: "1.6", margin: 0 }}>
                <b>Readers added context they thought people might want to know:</b><br/>
                While this claim was flagged by the baseline AI model, Verified Expert Reporters have manually confirmed that the 2026 UN Space Treaty was indeed signed yesterday in Geneva. The AI model's training data cutoff lacked this recent geopolitical context.
              </p>
            </div>
          )}
